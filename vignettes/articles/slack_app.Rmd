...
![Screenshot of an example Slack message authored by Steffi](slack_eg.png)
...
3. Install and authorize
   ...
   - Copy the Token and add it to your keyring in R:
     `keys_set("slack")` (which uses [keyring](https://keyring.r-lib.org/#usage) under the hood).
...
Now you're ready to start working with the [Slack functions in promoutils](slack.html).
