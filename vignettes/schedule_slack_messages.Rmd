...
final_channels <- channels |>
  ...
  mutate(
    ...
    descripcion = str_remove_all(description, "<https?://[^>]+>"),
    descripcion = str_squish (description)
    ) |>
...
The dataset `messages` now have the intro text for each channel we want to share in the Slack. 
